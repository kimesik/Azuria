...
/obj/item/book/rogue/bibble/zizo
	...
	desc = "By learning Her teachings, we will one day walk in Her footsteps. A volume forbidden to be read by the Holy See, containing a retelling of the mortal lyfe and ascension of ZIZO, the Lady of Progress - or at least the version recounted by scholars of Her Works."
